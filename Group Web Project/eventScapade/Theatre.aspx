...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="dgvTheatre" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="dgvEvents_SelectedIndexChanged" OnPageIndexChanged="dgvEvents_SelectedIndexChanged" CssClass="Grid" HorizontalAlign="Center"  >
